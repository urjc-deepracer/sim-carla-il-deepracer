...
MODEL_PATH = "experiments/exp_debug_1769712824/trained_models/pilot_net_model_best_123.pth"
image_shape = (224, 224, 4)        # 4 canales: RGB + speed
...
def main():
    ...
    try:
        while True:
            ...
            # ========= 3) Añadir 200 píxeles negros arriba (padding) =========
            h, w, c = mask.shape
            ...
            # ========= 5) Canal de velocidad =========
            speed_plane = torch.full((1,1,224,224), speed_norm,
                                    dtype=x.dtype, device=x.device)

            x4 = torch.cat([x, speed_plane], dim=1).to(device)  # (1,4,224,224)
