...
def main():
    ...
    client = carla.Client('localhost', 3333)
    ...
    try:
        while True:
            ...
            #print(f"speed={speed:.2f} m/s (norm={speed_norm:.2f}) | steer={steer:.3f} | throttle={throttle:.3f}")
            ...
            if camera_image["data"] is not None:
                ...
                if mode == "trail":
                    ...
                    # Suaviza para que parezca "mapa de calor" real
